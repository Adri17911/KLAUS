  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h1 className="text-4xl font-bold text-center text-gray-900 mb-2">KLAUS</h1>
          <h2 className="text-center text-xl text-gray-600">Sign in to your account</h2>
        </div>
        <form className="mt-8 space-y-6 bg-white p-8 rounded-lg shadow-xl" onSubmit={handleSubmit}>
          ...
          <div className="text-sm text-gray-600 text-center">
            <p>Default admin: admin@klaus.com / admin123</p>
          </div>
        </form>
      </div>
    </div>
